    ...
    Column {
        ...
        Box(modifier = modifier) {
            when (bikeApiState) {
                ...
                is BikeApiState.Success -> BikeListComponent(bikeOverviewState = bikeOverviewState, bikeListState = bikeListState)
            }
...
@Composable
fun BikeListComponent(modifier: Modifier = Modifier, bikeOverviewState: BikeOverviewState, bikeListState: BikeListState) {
